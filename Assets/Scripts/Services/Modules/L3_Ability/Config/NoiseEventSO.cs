...
namespace RedDust.Ability
{
    ...
    /// 实际音效由动画事件驱动，不由此资产播放。
    /// </summary>
    [CreateAssetMenu(menuName = "RedDust/Ability/Noise Event", fileName = "Noise_")]
    public sealed class NoiseEventSO : ScriptableObject
    {
        [Header("Noise")]
        [Tooltip("噪音类型。Tag_Noise_Weapon / Tag_Noise_HumanActivity / Tag_Noise_MonsterRoar。AI 行为路由。")]
