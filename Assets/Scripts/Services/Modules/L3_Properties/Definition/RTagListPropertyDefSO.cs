...
{
    [CreateAssetMenu(fileName = "RTagListDefinition", menuName = "RedDust/Properties/rTag List Definition")]
    public class RTagListPropertyDefSO : PropertyDefSO
    {
        private void OnEnable() { Type = PropertyType.rTagList; }
