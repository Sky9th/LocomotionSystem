...
namespace RedDust.Character.Combat
{
    ...
    /// 防御公式路由走基类 effectTag（Tag_Damage_Fire→火抗, Tag_Damage_Physical→护甲）。
    /// </summary>
    [CreateAssetMenu(menuName = "RedDust/Combat/Effect/Damage", fileName = "GE_Damage_")]
    public sealed class DamageEffectSO : GameplayEffectSO
    {
        [Header("Damage")]
        [Tooltip("基础伤害值。")]
