...
namespace RedDust.Character.Combat
{
    ...
    ///
    /// SkillDefSO 持有此资产引用，CombatDriver 消费。
    /// </summary>
    [CreateAssetMenu(menuName = "RedDust/Combat/Skill Activation", fileName = "Activation_")]
    public sealed class SkillActivationSO : ScriptableObject
    {
        ...
        public ESkillAnimationLayer animationLayer;
