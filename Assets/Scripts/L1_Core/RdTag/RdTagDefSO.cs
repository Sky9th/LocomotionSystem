...
namespace RedDust.Core
{
    ...
    /// 设计时使用父子引用组织层级，运行时通过隐式转换获取 <see cref="RdTag"/> struct。
    ///
    /// 改父级 leafName → 所有子孙 FullTag 自动更新（非字符串副本，安全重命名）。
    /// </summary>
    [CreateAssetMenu(menuName = "RedDust/RdTag", fileName = "Tag_")]
    public sealed class RdTagDefSO : ScriptableObject
    {
        ...
        public RdTagDefSO Parent => parent;
