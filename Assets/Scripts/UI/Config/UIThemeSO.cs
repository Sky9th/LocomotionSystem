...
public class UIThemeSO : ScriptableObject
{
    ...
    {
        primary = new(0.2f, 0.2f, 0.2f, 1f), primaryHover = new(0.35f, 0.35f, 0.35f, 1f),
        primaryPressed = new(0.12f, 0.12f, 0.12f, 1f), onPrimary = Color.white,
        surface = new(0.1f, 0.1f, 0.1f, 0.9f), surfaceAlt = new(0.16f, 0.16f, 0.16f, 1f),
        onSurface = new(0.85f, 0.85f, 0.85f, 1f), onSurfaceMuted = new(0.55f, 0.55f, 0.55f, 1f),
        border = new(0.25f, 0.25f, 0.25f, 1f),
    };

    public UIColorSet primaryColors = new()
    {
        primary = new(0.7f, 0.4f, 0.1f, 1f), primaryHover = new(0.85f, 0.5f, 0.12f, 1f),
        primaryPressed = new(0.5f, 0.28f, 0.07f, 1f), onPrimary = Color.white,
        surface = new(0.12f, 0.09f, 0.06f, 0.9f), surfaceAlt = new(0.18f, 0.14f, 0.1f, 1f),
        onSurface = new(0.9f, 0.88f, 0.82f, 1f), onSurfaceMuted = new(0.65f, 0.6f, 0.5f, 1f),
        border = new(0.35f, 0.25f, 0.15f, 1f),
    };

    public UIColorSet dangerColors = new()
    {
        primary = new(0.7f, 0.15f, 0.15f, 1f), primaryHover = new(0.85f, 0.18f, 0.18f, 1f),
        primaryPressed = new(0.5f, 0.1f, 0.1f, 1f), onPrimary = Color.white,
        surface = new(0.12f, 0.07f, 0.07f, 0.9f), surfaceAlt = new(0.18f, 0.11f, 0.11f, 1f),
        onSurface = new(0.9f, 0.85f, 0.85f, 1f), onSurfaceMuted = new(0.65f, 0.55f, 0.55f, 1f),
        border = new(0.35f, 0.18f, 0.18f, 1f),
    };

    public UIColorSet warningColors = new()
    {
        primary = new(0.7f, 0.55f, 0.1f, 1f), primaryHover = new(0.85f, 0.68f, 0.12f, 1f),
        primaryPressed = new(0.5f, 0.38f, 0.07f, 1f), onPrimary = new(0.1f, 0.1f, 0.1f, 1f),
        surface = new(0.12f, 0.1f, 0.06f, 0.9f), surfaceAlt = new(0.18f, 0.15f, 0.1f, 1f),
        onSurface = new(0.9f, 0.88f, 0.82f, 1f), onSurfaceMuted = new(0.65f, 0.6f, 0.5f, 1f),
    ...
    {
        primary = new(0.15f, 0.55f, 0.2f, 1f), primaryHover = new(0.18f, 0.68f, 0.24f, 1f),
        primaryPressed = new(0.1f, 0.4f, 0.14f, 1f), onPrimary = Color.white,
        surface = new(0.07f, 0.12f, 0.08f, 0.9f), surfaceAlt = new(0.11f, 0.18f, 0.13f, 1f),
        onSurface = new(0.85f, 0.9f, 0.87f, 1f), onSurfaceMuted = new(0.55f, 0.65f, 0.58f, 1f),
