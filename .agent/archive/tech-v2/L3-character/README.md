...
| [structs/s-character-kinematic.md](L4-kinematic/L5-structs/s-character-kinematic.md) | SCharacterKinematic struct |
| [structs/s-forward-obstacle-detection.md](L4-kinematic/L5-structs/s-forward-obstacle-detection.md) | SForwardObstacleDetection struct |
| [structs/s-ground-contact.md](L4-kinematic/L5-structs/s-ground-contact.md) | SGroundContact struct |
...
| [structs/s-character-motor.md](L4-locomotion/L5-structs/s-character-motor.md) | SCharacterMotor struct |
| [structs/s-character-discrete.md](L4-locomotion/L5-structs/s-character-discrete.md) | SCharacterDiscrete struct |
| [config/locomotion-profile.md](L4-locomotion/L5-config/locomotion-profile.md) | LocomotionProfile SO |
...
| [drivers/i-character-animation-driver.md](L4-L4-animation/L5-drivers/i-character-animation-driver.md) | ICharacterAnimationDriver 接口 |
| [drivers/base-character-animation-driver.md](L4-L4-animation/L5-drivers/base-character-animation-driver.md) | BaseCharacterAnimationDriver 基类 |
| [drivers/locomotion/locomotion-driver.md](L4-L4-animation/L5-drivers/locomotion/locomotion-driver.md) | LocomotionDriver 入口 |
| [drivers/locomotion/base-layer.md](L4-L4-animation/L5-drivers/locomotion/base-layer.md) | BaseLayer — 7 状态 FSM + ApplyTurnStepRotation |
| [drivers/locomotion/base-state-key.md](L4-L4-animation/L5-drivers/locomotion/base-state-key.md) | BaseStateKey 枚举 |
| [drivers/locomotion/locomotion-layer-fsm-state.md](L4-L4-animation/L5-drivers/locomotion/locomotion-layer-fsm-state.md) | FSM 状态基类 |
| [drivers/locomotion/states/base-idle-state.md](L4-L4-animation/L5-drivers/locomotion/states/base-idle-state.md) | 待机状态 |
| [drivers/locomotion/states/base-moving-state.md](L4-L4-animation/L5-drivers/locomotion/states/base-moving-state.md) | 移动状态 |
| [drivers/locomotion/states/base-idle-to-moving-state.md](L4-L4-animation/L5-drivers/locomotion/states/base-idle-to-moving-state.md) | 启动过渡 |
| [drivers/locomotion/states/base-turn-in-place-state.md](L4-L4-animation/L5-drivers/locomotion/states/base-turn-in-place-state.md) | 原地转身 |
| [drivers/locomotion/states/base-turn-in-moving-state.md](L4-L4-animation/L5-drivers/locomotion/states/base-turn-in-moving-state.md) | 移动中转身 |
| [drivers/locomotion/states/base-air-loop-state.md](L4-L4-animation/L5-drivers/locomotion/states/base-air-loop-state.md) | 空中循环 |
| [drivers/locomotion/states/base-air-land-state.md](L4-L4-animation/L5-drivers/locomotion/states/base-air-land-state.md) | 分级落地 |
| [drivers/traversal/traversal-driver.md](L4-L4-animation/L5-drivers/traversal/traversal-driver.md) | TraversalDriver 攀爬 |
| [config/animation-alias-profile.md](L4-L4-animation/L5-config/animation-alias-profile.md) | AnimationAliasProfile SO |
| [config/locomotion-animation-profile.md](L4-L4-animation/L5-config/locomotion-animation-profile.md) | LocomotionAnimationProfile SO |
| [config/locomotion-mode-profile.md](L4-L4-animation/L5-config/locomotion-mode-profile.md) | LocomotionModeProfile SO |
| [requests/animation-request.md](L4-L4-animation/L5-requests/animation-request.md) | AnimationRequest |
| [requests/on-complete-behavior.md](L4-L4-animation/L5-requests/on-complete-behavior.md) | 完成行为枚举 |
| [requests/on-interrupted-behavior.md](L4-L4-animation/L5-requests/on-interrupted-behavior.md) | 中断行为枚举 |
...
| [config/character-audio-config-so.md](L4-audio/L5-config/character-audio-config-so.md) | CharacterAudioConfigSO |
| [config/footstep-set-so.md](L4-audio/L5-config/footstep-set-so.md) | FootstepSetSO |
