# InputActionHandler · 动作处理器基类

> `Assets/Scripts/Inputs/Actions/InputActionHandler.cs` — 抽象基类，ScriptableObject。持有 InputActionReference，提供 Initialize/Enable/Disable/Dispose 生命周期。
