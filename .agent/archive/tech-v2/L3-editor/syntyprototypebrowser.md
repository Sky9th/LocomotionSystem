# SyntyPrototypeBrowser · Prototype 浏览器

> `Editor/SyntyPrototypeBrowser.cs` — EditorWindow，分类展示 PolygonPrototype Prefab 缩略图，支持材质替换和搜索
...
- **参数**: `categories` — 由 SyntyPrototypeMenu.ScanAllFolders() 生成的分分类 Prefab 列表
