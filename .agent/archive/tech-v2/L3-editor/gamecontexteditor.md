# GameContextEditor · Context 调试面板

> `Editor/GameContextEditor.cs` — 自定义 Inspector，运行时显示 GameContext 的 Service Registry 和 Snapshot Cache 状态
...
| 方向 | 模块 | 关系 |
|------|------|------|
| 依赖 | 01-core (GameContext) | 读取 GameContext 运行时属性用于展示 |
