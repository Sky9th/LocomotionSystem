...
> `Audio/AudioManager.cs` — BaseService，提供音频通道音量分组控制，预留 AudioSource 池化和 3D 音频扩展
...
| 方向 | 模块 | 关系 |
|------|------|------|
| 依赖 | 01-core GameContext | 通过 RegisterService 注册 |
| 依赖 | 01-core BaseService | 继承自 BaseService |
