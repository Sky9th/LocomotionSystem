# GizmoDebugUtility
> **源文件**: `Assets/Scripts/Utility/GizmoDebugUtility.cs`

将常见的 Gizmos + Handles 绘制模式封装为静态方法，降低调试代码重复。
...
- **备注**: `size.sqrMagnitude <= Mathf.Epsilon` 时跳过
