# SIActionStand
> **源文件**: `Assets/Scripts/Inputs/Structs/Control/Button/SIActionStand.cs`

站立意图的规范载荷。包装 SButtonInputState，标识站立姿态切换请求。

## 调用链

```
IAPlayerStand.Execute()
  └── SIActionStand.CreateEvent(isPressed, phase)
...
| 方向 | 模块 | 关系 |
|------|------|------|
| 生产者 | IAPlayerStand | CreateEvent 生产 |
