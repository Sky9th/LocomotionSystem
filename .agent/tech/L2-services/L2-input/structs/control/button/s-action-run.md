# SIActionRun
> **源文件**: `Assets/Scripts/Inputs/Structs/Control/Button/SIActionRun.cs`

跑步切换意图的规范载荷。包装 SButtonInputState，标识 Locomotion Gait 切换。

## 调用链

```
IAPlayerRun.Execute()
  └── SIActionRun.CreateEvent(isPressed, phase)
...
| 方向 | 模块 | 关系 |
|------|------|------|
| 生产者 | IAPlayerRun | CreateEvent 生产 |
...
> 注: XML 注释误写为 "jump intent"（代码缺陷，SIActionRun.cs:5）。
