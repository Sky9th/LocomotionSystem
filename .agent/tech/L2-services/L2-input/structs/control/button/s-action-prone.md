# SIActionProne
> **源文件**: `Assets/Scripts/Inputs/Structs/Control/Button/SIActionProne.cs`

趴下意图的规范载荷。包装 SButtonInputState，标识趴下姿态切换请求。

## 调用链

```
IAPlayerProne.Execute()
  └── SIActionProne.CreateEvent(isPressed, phase)
...
| 方向 | 模块 | 关系 |
|------|------|------|
| 生产者 | IAPlayerProne | CreateEvent 生产 |
