# SIActionCrouch
> **源文件**: `Assets/Scripts/Inputs/Structs/Control/Button/SIActionCrouch.cs`

蹲下意图的规范载荷。包装 SButtonInputState，标识蹲下姿态切换请求。

## 调用链

```
IAPlayerCrouch.Execute()
  └── SIActionCrouch.CreateEvent(isPressed, phase)
...
| 方向 | 模块 | 关系 |
|------|------|------|
| 生产者 | IAPlayerCrouch | CreateEvent 生产 |
...
- **返回**: SIActionCrouch 实例
- **调用者**: IAPlayerCrouch.Execute()
