# SIActionJump
> **源文件**: `Assets/Scripts/Inputs/Structs/Control/Button/SIActionJump.cs`

跳跃意图的规范载荷。包装 SButtonInputState，标识跳跃相位切换请求。

## 调用链

```
IAPlayerJump.Execute()
  └── SIActionJump.CreateEvent(isPressed, phase)
...
| 方向 | 模块 | 关系 |
|------|------|------|
| 生产者 | IAPlayerJump | CreateEvent 生产 |
