# IAPlayerRun
> **源文件**: `Assets/Scripts/Inputs/Actions/Player/Button/IAPlayerRun.cs`

继承 InputActionHandler。读取按钮状态 → 组装 SIActionRun → 发布事件。
...
Unity Input System (Performed/Canceled)
  └── handler.Execute(context)
      ...
      ├── SIActionRun.CreateEvent(isPressed, context.phase)
...
| 发布 | SIActionRun | EventDispatcher 广播 |
| 消费 | 02-character (CharacterEventReceiver) | 订阅 SIActionRun |
