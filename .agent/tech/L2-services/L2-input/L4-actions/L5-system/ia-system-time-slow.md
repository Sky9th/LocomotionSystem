# IASystemTimeSlow
> **源文件**: `Assets/Scripts/Inputs/Actions/System/IASystemTimeSlow.cs`

继承 InputActionHandler。按住时发布 SIActionWorldSpeed，控制 Time.timeScale 减速。
...
| 参数 | 类型 | 默认值 | 用途 |
|------|------|--------|------|
| `slowScale` | float [0.01, 1] | 0.1f | 减速目标值 |
...
- **备注**: 只在 performed 时发布，canceled 不处理；IsEnabled 时处理
